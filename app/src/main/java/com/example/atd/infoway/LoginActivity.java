...
public class LoginActivity extends AppCompatActivity implements
    ...
    private static final String TWITTER_KEY = "YzjUGjrWRlxxAuj1mG3Iqku0Q";
    private static final String TWITTER_SECRET = "Wla6BZirHUaszQRsyrrjlvZ8aO2vIWHALzs8U222rJr1xUu0Qf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentr = new Intent(this, RegisterActivity.class);
        intents = new Intent(this, SuccessActivity.class);

        Button mRigsterButton = (Button) findViewById(R.id.register_button);
        mRigsterButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Log.d("GOOGLEPLUS: ", "PersonName: " + personName + " given name: " + personGivenName + "fam name:" + personFamilyName);
            // mStatusTextView.setText(getString(R.string.signed_in_fmt, acct.getDisplayName()));
            // insert user in DB if it entry doesn't exist, otherwise login.
            // updateUI(true);
        } else {
